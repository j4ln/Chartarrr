...
document
  .getElementById("button-clarification")
  .addEventListener("click", addComment);
document
  .getElementById("button-screenshot")
  .addEventListener("click", takeScreenshot);
document
  .getElementById("attachment-preview")
  .addEventListener("click", previewAttachment);
document
  .getElementById("attachment-delete")
  .addEventListener("click", deleteAttachment);
document
  .getElementById("button-details")
  .addEventListener("click", viewSession);
